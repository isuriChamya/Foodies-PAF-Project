...
const CreatePlanModal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submissionData.ownerId = localStorage.getItem("userId");
      
      // Call API to create the plan
      await planApi.createLearningPlan(submissionData);
    ...
    <>
      <ToastContainer position="top-right" autoClose={3000} />
        ...
        <div className="relative">
          ...
          <h2 className="text-2xl font-bold mb-6 text-center text-indigo-700">Create Learning Plan</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end space-x-3 border-t pt-4">
              ...
              <button
                type="submit"
                className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 ${
